...
class ModuleConcatenationPlugin {
			...
			compilation.hooks.optimizeChunkModules.tapAsync(
				...
				(allChunks, modules, callback) => {
					...
					for (const currentRoot of relevantModules) {
						...
						// potential optional import data
						/** @type {Set<Module>} */
	 ...
	 * @param {Set<Module>} possibleModules modules that are data
	 * @param {Set<Module>} candidates list of potential data (will be added to)
	...
	_tryToAdd(
		...
		// Add imports to possible data list
