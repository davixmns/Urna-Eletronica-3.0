...
- Only check selectors containing base apply data for circular dependencies ([#8222](https://github.com/tailwindlabs/tailwindcss/pull/8222))
...
- Don't crash when scanning extremely long class data ([#7331](https://github.com/tailwindlabs/tailwindcss/pull/7331))
